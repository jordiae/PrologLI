...
% 1: rotated
occupyCellForTypeSizeAndStartCell(1,W,H,Start_X,Start_Y,Work_X,Work_Y):- W2 is H+Start_X-1,H2 is W+Start_Y-1, cell(W2,H2), between(Start_X,W2,Work_X), between(Start_Y,H2,Work_Y).
% 2: no rotated
occupyCellForTypeSizeAndStartCell(2,W,H,Start_X,Start_Y,Work_X,Work_Y):- W2 is W+Start_X-1,H2 is H+Start_Y-1, cell(W2,H2), between(Start_X,W2,Work_X), between(Start_Y,H2,Work_Y).
...
satisfyDemand:-
    ...
    findall(pieceStarts-PP-A-B, cell(A,B), D),
    exactly(1,D),
...
followPatterns:-
    ...
    type(T),
    pieceSize(P,W,H),
    occupyCellForTypeSizeAndStartCell(T,W,H,Start_X,Start_Y,Work_X,Work_Y),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,\+pieceType-P-T,pieceCell-P-Work_X-Work_Y]),
    fail.
followPatterns.
...
followPatternsNo:-
    ...
    type(T),
    pieceSize(P,W,H),
    findall(Work_X-Work_Y,occupyCellForTypeSizeAndStartCell(T,W,H,Start_X,Start_Y,Work_X,Work_Y),R),
    cell(Work_X-Work_Y),
