...
% 2: no rotated
occupyCellForTypeSizeAndStartCell(\+rotated,W,H,Start_X,Start_Y,Work_X,Work_Y):- W2 is W+Start_X-1,H2 is H+Start_Y-1, cell(W2,H2), between(Start_X,W2,Work_X), between(Start_Y,H2,Work_Y).
...
putPieces:-
    ...
    writeClause([\+pieceStarts-P-Start_X-Start_Y,T-P,pieceCell-P-Work_X-Work_Y]),
    fail.
putPieces.
