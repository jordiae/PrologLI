...
% 1: rotated
occupyCellForTypeSizeAndStartCell(rotated,W,H,Start_X,Start_Y,Work_X,Work_Y):- W2 is H+Start_X-1,H2 is W+Start_Y-1, cell(W2,H2), between(Start_X,W2,Work_X), between(Start_Y,H2,Work_Y).
% 2: not rotated
occupyCellForTypeSizeAndStartCell(not_rotated,W,H,Start_X,Start_Y,Work_X,Work_Y):- W2 is W+Start_X-1,H2 is H+Start_Y-1, cell(W2,H2), between(Start_X,W2,Work_X), between(Start_Y,H2,Work_Y).

cell(X-Y):-cell(X,Y).

writeClauses(K):-
    eachPieceExactlyOneStart,
    eachXCellFilled,
    eachDotCellNotFilled,
    putPieces,
    dontPutPieces,
    atMostKPiecesUsed(K).
...
eachPieceExactlyOneStart:-
    piece(P),
    findall(pieceStarts-P-X-Y, cell(X,Y), C),
    exactly(1,C), %
    fail.
eachPieceExactlyOneStart.
...
eachXCellFilled:-
    ...
    findall(pieceCell-P-X-Y, piece(P),C),
    exactly(1,C),


    member(pieceCell-PP-X-Y,C),
    writeClause([\+pieceCell-PP-X-Y,used-PP]),
...
putPieces:-
    ...
    pieceSize(P,W,H),
    occupyCellForTypeSizeAndStartCell(rotated,W,H,Start_X,Start_Y,Work_X_Rot,Work_Y_Rot),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,\+rotated-P,pieceCell-P-Work_X_Rot-Work_Y_Rot]),
    occupyCellForTypeSizeAndStartCell(not_rotated,W,H,Start_X,Start_Y,Work_X_No_Rot,Work_Y_No_Rot),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,rotated-P,pieceCell-P-Work_X_No_Rot-Work_Y_No_Rot]),
    fail.
putPieces.
...
dontPutPieces:-
    ...
    cell(Start_X,Start_Y),
    pieceSize(P,W,H),
    findall(Work_X_Rot-Work_Y_Rot,occupyCellForTypeSizeAndStartCell(rotated,W,H,Start_X,Start_Y,Work_X_Rot,Work_Y_Rot),R),
    cell(Work_X_Rot-Work_Y_Rot),
    not(member(Work_X_Rot-Work_Y_Rot,R)),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,\+rotated-P,\+pieceCell-P-Work_X_Rot-Work_Y_Rot]),
    findall(Work_X_No_Rot-Work_Y_No_Rot,occupyCellForTypeSizeAndStartCell(not_rotated,W,H,Start_X,Start_Y,Work_X_No_Rot,Work_Y_No_Rot),R),
    cell(Work_X_No_Rot-Work_Y_No_Rot),
    not(member(Work_X_No_Rot-Work_Y_No_Rot,R)),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,rotated-P,\+pieceCell-P-Work_X_No_Rot-Work_Y_No_Rot]),
    fail.
dontPutPieces.
