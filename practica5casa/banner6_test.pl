...
putPiecesRot:-
    ...
    pieceSize(P,W,H),
    occupyCellForTypeSizeAndStartCell(rotated,W,H,Start_X,Start_Y,Work_X,Work_Y),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,\+rotated-P,pieceCell-P-Work_X-Work_Y]),
    fail.
putPiecesRot.
...
putPiecesNoRot:-
    ...
    cell(Start_X,Start_Y),
    pieceSize(P,W,H),
    occupyCellForTypeSizeAndStartCell(not_rotated,W,H,Start_X,Start_Y,Work_X,Work_Y),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,rotated-P,pieceCell-P-Work_X-Work_Y]),
    fail.
putPiecesNoRot.
...
dontPutPiecesRot:-
    ...
    cell(Start_X,Start_Y),
    pieceSize(P,W,H),
    findall(Work_X-Work_Y,occupyCellForTypeSizeAndStartCell(rotated,W,H,Start_X,Start_Y,Work_X,Work_Y),R),
    cell(Work_X-Work_Y),
    not(member(Work_X-Work_Y,R)),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,\+rotated-P,\+pieceCell-P-Work_X-Work_Y]),
    fail.
dontPutPiecesRot.
...
dontPutPiecesNoRot:-
    ...
    cell(Start_X,Start_Y),
    pieceSize(P,W,H),
    findall(Work_X-Work_Y,occupyCellForTypeSizeAndStartCell(not_rotated,W,H,Start_X,Start_Y,Work_X,Work_Y),R),
    cell(Work_X-Work_Y),
    not(member(Work_X-Work_Y,R)),
    writeClause([\+pieceStarts-P-Start_X-Start_Y,rotated-P,\+pieceCell-P-Work_X-Work_Y]),
    fail.
