...
writeClauses(K):-
    atMostKPiecesUsed(K),
    eachPieceAtMostOneStart,
    putPieces,
    doNotPutPieces,
    everyXCellFilled,
    everyDotCellNotFilled,
    ifUsedThenHasStart,
    eachPieceExactlyOneType,
    typeMeaning,
    eachCellAtMostOneStart.
...
putPieces:-
    ...
    \+between(Y,H2,B),
    cell(C,D),
    writeClause([sicomença-P-X-Y-iNOestarotada-P-aleshoresocupa-P-WW-HH]),
    writeClause([sicomença-P-X-Y-SÍestarotada-P-aleshoresocupa-P-HH-WW]),

    writeClause([\+pieceType-P-2,\+pieceStarts-P-X-Y,pieceCell-P-WW-HH]),
    writeClause([\+pieceType-P-1,\+pieceStarts-P-X-Y,pieceCell-P-HH-WW]),
...
doNotPutPieces:-
   ...
   % writeClause([used-P,\+pieceStarts-P-X-Y]),
    ...
    \+between(Y,H2,B),
    cell(C,D),
    writeClause([sicomença-P-X-Y-iNOestarotada-P-aleshoresNOocupa-P-A-D]),
    writeClause([sicomença-P-X-Y-iNOestarotada-P-aleshoresNOocupa-P-C-B]),
    writeClause([sicomença-P-X-Y-SIestarotada-P-aleshoresNOocupaP-P-C-A]),
    writeClause([sicomença-P-X-Y-SÍestarotada-P-aleshoresNOocupaP-P-B-D]),

    writeClause([\+pieceType-P-2,\+pieceStarts-P-X-Y,\+pieceCell-P-A-D]),
    writeClause([\+pieceType-P-2,\+pieceStarts-P-X-Y,\+pieceCell-P-C-B]),
    writeClause([\+pieceType-P-1,\+pieceStarts-P-X-Y,\+pieceCell-P-C-A]),
    writeClause([\+pieceType-P-1,\+pieceStarts-P-X-Y,\+pieceCell-P-B-D]),
    fail.
doNotPutPieces.
...
everyDotCellNotFilled:-
    ...
    exactly(0,Lits),
    fail.
everyDotCellNotFilled. % mirar correccio "sense sentit" de mail nursesifUsedThenHasStart.
...
eachPieceExactlyOneType:-
    piece(P),
    findall(pieceType-P-T, type(T), C),
    exactly(1,C),
    fail.
eachPieceExactlyOneType.
...
typeMeaning:-
    piece(P),
    writeClause([\+pieceType-P-1,rotated-P]),
    writeClause([\+pieceType-P-2,\+rotated-P]),
    fail.
typeMeaning.
