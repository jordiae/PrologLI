...
% predicats afegits
% nota: com a banner, comptare que [1,1] bottom-left
% les coordenades son tambe bottom left
...
main:- 
    ...
    labeling([ff,up,bisect],L), % ff: first fail, up:try in ascending order, bisect: For each variable X, a choice is made between X #=< M and X #> M, where M is the midpoint of the domain of X.
